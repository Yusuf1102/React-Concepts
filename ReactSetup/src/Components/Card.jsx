       ...
       <div className='w-52 h-full bg-zinc-100 rounded-lg flex flex-col items-center justify-center p-2 '>
                      <div className='image w-[3vw] h-[3vw] rounded-full bg-zinc-800 overflow-hidden'>
                          <img className='w-full h-full object-cover' src={user.image} alt="" />
                            ...
                            <p className='mt- 1 text-center text-xs font-semibold leadin-1 tracking-tight'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis ducimus architecto eum. </p>
